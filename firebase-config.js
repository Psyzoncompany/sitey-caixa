...
const PREVIEW_DOMAIN_HINT = "sitey-caixa-git-codex-implementa-99a3db-psyzoncompanys-projects.vercel.app";
if (window.location.hostname.includes("vercel.app")) {
    console.warn(`⚠️ Domínio preview (${window.location.hostname}) não autorizado para OAuth popup/redirect no Firebase. Use login por e-mail/senha ou adicione ${PREVIEW_DOMAIN_HINT} em Authentication > Settings > Authorized domains.`);
}
